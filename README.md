...
```bash
colmap image_undistorter --image_path ./logs/frames --input_path ./logs/points/0 --output_path ./logs/dense --output_type COLMAP
colmap patch_match_stereo --workspace_path ./logs/dense --workspace_format COLMAP --PatchMatchStereo.max_image_size 2000
colmap stereo_fusion --workspace_path ./logs/dense --output_path ./logs/dense/fused.ply
```
